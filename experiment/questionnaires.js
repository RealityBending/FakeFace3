...
const mist_items = {
    // Fake general items
    MIST_fake_general_1: "Government Officials Have Manipulated Stock Prices to Hide Scandals",
    MIST_fake_general_2: "New Study: Left-Wingers Are More Likely to Lie to Get a Higher Salary",
    MIST_fake_general_3: "Certain Vaccines Are Loaded with Dangerous Chemicals and Toxins",
    MIST_fake_general_4: "The Government Is Knowingly Spreading Disease Through the Airwaves and Food Supply",
    // Real general items
    MIST_real_general_1: "Attitudes Toward EU Are Largely Positive, Both Within Europe and Outside It",
    MIST_real_general_2: "Hyatt Will Remove Small Bottles from Hotel Bathrooms",
    MIST_real_general_3: "Republicans Divided in Views of Trump's Conduct, Democrats Are Broadly Critical",
    MIST_real_general_4: "Global Warming Age Gap: Younger Americans Most Worried",
}
