...
#   # Reverse
#   mutate(BAIT_2_ImagesIssues = 6 - BAIT_2_ImagesIssues,
...
df <- df |> 
  ...
  summarize(MIST_p_True = sum(Response >= 0) / n(), .by="Participant") |> 
...
data_final <- df |>
  select(Participant, Age, Gender, SexualOrientation, Ethnicity, MIST_totalcorrect, BAIT_total, BRS_Total, Questionnaires_AttentionCheck) |>
 ...
 arrange(as.numeric(gsub("\\D", "", Participant))) |>
  mutate(
    ...
    SexualOrientation = sample(SexualOrientation),
